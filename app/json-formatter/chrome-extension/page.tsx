...
export const metadata: Metadata = {
  title: 'JSON Formatter for Chrome — Browser Extension',
  description:
    'Install the JSON Formatter Chrome extension to turn raw JSON pages into a visually intuitive, interactive experience — color-coded formatting, image previews, clickable URLs, and collapsible trees.',
  alternates: { canonical: '/json-formatter/chrome-extension' },
};

export default function JsonFormatterChromeExtensionPage() {
  return (
    <>
      <ToolNav />
      ...
      <Container className="py-4">
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm mb-10" style={{ color: 'var(--text-muted)' }}>
            Prefer to format JSON right here in your browser? Use the{' '}
