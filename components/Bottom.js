		...
		<footer className="w-full bg-white py-12 pb-20 px-4 lg:px-10 dark:bg-slate-700" aria-labelledby="footer-heading">
		    <div className="max-w-7xl mx-auto">
		        ...
		        <ul className="tools grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
		            <li>
		                <a href="https://jscompress.com/" rel="noopener">
		                    <strong>JSCompress</strong>
		                    <span>The JavaScript Compression Tool</span>
		                </a>
		            </li>
		            <li>
		                <a href="https://randomkeygen.com/" rel="noopener">
		                    <strong>RandomKeygen</strong>
		                    <span>The Random Password Generator</span>
		                </a>
		            </li>
		            <li>
		                <a href="https://jsoncompare.com/" rel="noopener">
		                    <strong>JSONCompare</strong>
		                    <span>The Advanced JSON Linter</span>
		                </a>
		            </li>
		            <li>
		                <a href="https://dns-lookup.com/" rel="noopener">
		                    <strong>DNS-Lookup</strong>
		                    <span>Professional DNS & IP Lookup Tool</span>
		                </a>
		            </li>
		            <li>
		                <a href="https://validatejavascript.com/" rel="noopener">
		                    <strong>ValidateJavaScript</strong>
		                    <span>Quickly Find & Fix JavaScript Errors</span>
		                </a>
		            </li>
		            <li>
		                <a href="https://colors.to/" rel="noopener">
		                    <strong>Colors.to</strong>
		                    <span>Generate color palette codes</span>
		                </a>
		            </li>
		            <li>
		                <a href="https://whatismyip.io/" rel="noopener">
